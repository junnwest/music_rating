...
> 8. **⏳ Send Windows prompt** — Windows PC needs to: (a) ingest Western artists via pipeline to resolve the 452 pending `external_scores` entries; (b) seed RS500 + Pitchfork 10.0 via `/browse`; (c) fill Grammy Dance/Electronic 2009–2013 + 2018 winner; (d) seed Brit Award if time allows. Prompt written and ready — see SESSIONS.md 2026-06-29 entry.
