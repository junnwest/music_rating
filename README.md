...
> - ⏳ **Still needs the migration applied**: `20260703000005_song_charts_lateral_fix.sql` (the anon-timeout fix) — not yet run as of this session's end.
>
