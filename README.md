...
17. **Next:** Apply `20260620000002_charts_rpcs.sql` + `20260620000003_charts_song_rpcs.sql` in SQL editor. Create `avatars` storage bucket in Supabase Storage → re-enable avatar uploads in `EditProfileView`. Wire Report/Block no-ops in feed card menu. Profile > Stats subtab. Complete TestFlight setup once Apple Developer account is active.
18. **Later:** MusicKit integration (Apple login), Spotify `user-top-read` sync — see `WEB_PARITY.md` §3
