...
21. **Next:** Profile > Stats subtab. Complete TestFlight setup once Apple Developer account is active. ✅ `avatars` storage bucket confirmed created.
22. **Later:** MusicKit integration (Apple login), Spotify `user-top-read` sync — see `WEB_PARITY.md` §3
