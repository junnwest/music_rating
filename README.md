...
19. **Next:** Wire Report/Block no-ops in feed card menu. Profile > Stats subtab. Complete TestFlight setup once Apple Developer account is active. ✅ `avatars` storage bucket confirmed created.
