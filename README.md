...
>
> **⚑ FOR WINDOWS — 4 systemic pipeline gaps found via one-off Mac bug reports (2026-07-09/10). Each was only fixed for the single reported row — none of these have been audited catalog-wide. Treat the two entries below (the YANGHONGWON title/cover/name fixes) as *symptoms*, not the actual fix; the real fix for each is a script/design decision on this list:**
>
...
>
> None of the four above are "fix once and done" — they're catalog-wide risk patterns first surfaced by single user reports. See the two SESSIONS.md/README entries directly below for the specific one-row fixes that prompted this list.
>
