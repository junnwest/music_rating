  ...
  const sections = [
    {
      ...
      body: "We collect information you provide directly when creating an account, including your email address, display name, username, and profile photo. We also collect activity data you generate — ratings, written reviews, Pinned Ten selections, and Listen Later saves. We collect usage data such as pages visited, search queries, and interaction data to improve the service.",
    },
    {
      icon: Lock,
