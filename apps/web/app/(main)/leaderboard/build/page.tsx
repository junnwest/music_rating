...
export default async function LeaderboardBuildPage({
  searchParams,
}: {
    ...
    <div className="bg-page min-h-screen">
      <div className="bg-surface border-b border-divider">
        <div className="max-w-[1100px] mx-auto px-5 py-12 md:py-16">
          <Link href="/leaderboard" className="text-[13px] text-muted hover:text-ink transition inline-flex items-center gap-1.5 mb-6">
            ← Back to Leaderboard
          </Link>
      ...
      <div className="max-w-[1100px] mx-auto px-5 py-10 pb-20">
        {matchingCategories.length > 0 ? (
            ...
            <div className="grid gap-3" style={{ gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))' }}>
              {matchingCategories.map((cat) => (
                ...
                >
                  ...
                  <p className="text-[12px] font-semibold text-ink mt-3">View →</p>
                </Link>
              ))}
            </div>
          </>
          ...
          <div className="py-20 text-center">
            <p className="text-[16px] font-bold text-ink mb-2">No leaderboards found yet</p>
            <p className="text-[14px] text-muted max-w-[380px] mx-auto mb-6">
              There are no community leaderboards for this filter combination yet.
            </p>
            <Link
              href="/leaderboard"
