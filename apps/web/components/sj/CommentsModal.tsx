 ...
 * the row, matching Instagram's own comment editing flow. Pass `mixShareId`
 * instead of `ratingId` for a mix post's thread (`mix_share_comments`, the
 * 1:1 mirror of `rating_comments`).
 */
